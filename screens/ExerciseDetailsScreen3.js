...
const ExerciseDetailsScreen3 = ({route,navigation}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1, position: 'relative'}}>
      ...
      <View
        ...
        />
        <Text style={{fontSize: 30, lineHeight: 45}}>{meditation.title}</Text>
        <Text style={{fontSize: 16, opacity: 0.6, marginVertical: 10}}>
          {meditation.duration}
        </Text>
        <Text style={{fontSize: 16, width: '85%'}}>{meditation.subTitle}</Text>
      ...
      <View style={{marginTop: -60, marginHorizontal: 15}}>
        ...
        />
        <Text style={{marginVertical: 15, fontSize: 20}}>{meditation.title}</Text>
        <TouchableOpacity flex
      onPress={() =>
...
export default ExerciseDetailsScreen3;