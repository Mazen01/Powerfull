...
import argonTheme from '../constants/theme2'
        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Power</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>Full</Text>
                </Block>
                <Block row>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Coming soon sessions from Certified Coaches only for you at a minimum fee. Register now for access to premuim content.
              </Text>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>Pre-Register</Text>
              </Button>
            </Block>
          </Block>
        </Block>
