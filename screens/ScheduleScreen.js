...
import logo from '.././assets/whitefontlogo.png';
// Unleash the demo :D
...
export default function ScheduleScreen() {
  ...
  return (
    ...
    <Image source={logo} style={{width: 60, height: 60, position: 'absolute', top: 30, right: 40,}} />
      ...
      <Text style={styles.headerSubtitle} >Made Just for You </Text>
      <Text style={styles.textAboveWorkouts} >No Equipment Eeeded </Text>
      <FlatList
      data={workouts}
